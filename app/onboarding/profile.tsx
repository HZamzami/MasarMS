...
const PHENOTYPES: Array<{
...
}> = [
  {
    ...
    shortLabel: 'RRMS',
    subtitle: 'The most common form — relapses followed by recovery periods.',
  ...
  },
  {
    ...
    shortLabel: 'SPMS',
    subtitle: 'Steady progression after an initial relapsing-remitting course.',
...
export default function ProfileSetup() {
  ...
  async function handleSubmit() {
    ...
    // for the 84-day baseline countdown.
      ...
      >
        ...
        >
          ...
          {step === 1 && (
            <>
              ...
              <Text className="text-on-surface-variant leading-relaxed mb-8">
                This helps us calibrate your monitoring protocol to your specific MS course.
              </Text>
              ...
              >
                ...
                <Text className="flex-1 text-xs text-on-surface-variant leading-5">
                  Not sure which type applies to you? Your neurologist or care team can confirm this.
          ...
          {step === 2 && (
            <>
              ...
              <Text className="text-on-surface-variant leading-relaxed mb-8">
                These details help us personalise your baseline and flag meaningful changes
        ...
        >
          <TouchableOpacity
            ...
            accessibilityRole="button"
            accessibilityLabel={step === 1 ? 'Next step' : 'Complete setup'}
          >
            {loading ? (
